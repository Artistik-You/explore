...
//----------- featured wrapper slider js -------------//
            ...
            jQuery(document).ready(function(t) {
                adonisObj.toggleOffArtistikYous = function(e) {
                    var a = t(e).hasClass("show") ? "hide" : "show";
                    return "show" == a ? (t(e).addClass("show"), t("body").addClass("off-ArtistikYous-overlay-on")) : (t(e).removeClass("show"), t("body").removeClass("off-ArtistikYous-overlay-on")), "" == t(".off-ArtistikYous-overlay").attr("data-target") || void 0 === t(".off-ArtistikYous-overlay").attr("data-target") ? t(".off-ArtistikYous-overlay").attr("data-target", e) : t(".off-ArtistikYous-overlay").removeAttr("data-target"), a
                }, adonisObj.ajaxify = function() {
                    if (!0 === filterlinks(_url)) {
                        if (t(this).parents(".off-ArtistikYous").length > 0) {
                            var a = t(this).parents(".off-ArtistikYous"),
                                o = void 0 !== a.attr("data-close-offArtistikYous-below") ? a.attr("data-close-offArtistikYous-below") : "";
                            t(window).outerWidth() < parseInt(o) && adonisObj.toggleOffArtistikYous(a)
                        }
                        e.preventDefault(), adonisObj.hideOffArtistikYous()
                    }
                }, t(document).on("click", ".toggle-off-ArtistikYous,.off-ArtistikYous-overlay,.close-offArtistikYous", function(e) {
                    e.preventDefault(), adonisObj.toggleOffArtistikYous(t(this).attr("data-target"))
                })
            });
